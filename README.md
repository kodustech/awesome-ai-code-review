...
- **[EDC](https://github.com/almogdepaz/EDC)** - Local repo-context and differential review workflow for coding agents. Generates module docs, invariants, trust boundaries, review notes, and routing metadata under `edc-context/`, then routes changed files through the relevant context for Claude Code, Cursor, Codex, and pi.
