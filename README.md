...
- **[Multi-Judge Consensus](https://github.com/ElonAug7/multi-judge-consensus)** - Zero-dependency, local-first Python review committee: DeepSeek, GLM and Qwen judges independently review agent-generated content, a deterministic verifier catches date/percentage/sum errors without any LLM, and rule-based arbitration with bounded cross-debate decides pass/revise/reject. Ships CI gate exit codes, an MCP server, an HTTP API, and a local WebUI.
